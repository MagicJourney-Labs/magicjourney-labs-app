    ...
    <footer className=" text-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div className=" flex items-center flex-col p-1 sm:grid grid-cols-2 grid-rows-2 gap-2  lg:flex lg:flex-row lg:items-center lg:justify-between ">
          ...
          <div className="p-10 md:flex flex-col md:items-center lg:items-start">
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              <Link href="mailto:mjl@gmail.com">info@example.com</Link>
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mr-3 h-5 w-5">
                <path
              ...
              <Link href="tel:+37061111111">+37061111111111</Link>
            </p>
          </div>
        </div>
      </div>
      <div className="pt-1   md:container pt-9">
        <div className="mb-9 flex justify-center">
          ...
          <Link href="https://github.com/MagicJourney-Labs" className="text-neutral-800 dark:text-neutral-200">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className=" p-1 text-center text-neutral-700  dark:text-neutral-200">
        © 2023 Copyright:
        <Link className="hover:underline text-neutral-800 dark:text-neutral-400" href="http://localhost:3001/">
          MagicJourneyLabs
        </Link>
      </div>
    </footer>
