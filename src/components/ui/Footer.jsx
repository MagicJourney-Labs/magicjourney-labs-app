    ...
    <footer className='flex  xl:flex  flex-col  self-stretch items-center'>
      <section className='xl:flex  pt-16 pb-12 flex-col self-stretch border-t-2 border-t-gray-400'>
        <div className='flex  px-8 flex-col items-start'>
          <div className='flex-col justify-between sm:flex-col md:flex-col md:w-full md:gap-8 lg:flex-row xl:flex-row flex items-start lg:gap-16 gap-24 self-stretch'>
      ...
      <section className='xl:flex  pt-12 pb-12 flex-col self-stretch border-t-2 border-t-gray-400'>
        <div className='flex  px-8 flex-col items-start gap-12'>
          <div className='flex-col justify-between sm:flex-row md:flex-row md:w-full lg:flex-row xl:flex-row flex items-start lg:gap-16 gap-8 self-stretch'>
            <div>
