  ...
  return (
    <footer className="flex lg:w-full xl:flex w-full flex-col items-center self-stretch">
      <div className=" sm:px-8 md:px-8 lg:px-8 w-fit ">
        <section className="xl:flex  pt-16 pb-12 flex-col items-center gap-16 self-stretch border-t-2 border-t-gray-400">
        ...
        <section className=" flex-col items-center px-8 flex pb-12 py-12 gap-16 justify-between sm:flex-row md:flex-row lg:flex-row border-t-2 border-t-gray-400">
          <div className=" ">
            <p>{copyright.text}</p>
          </div>
