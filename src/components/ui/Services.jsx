  ...
  return (
    <div className='pt-20 pb-20'>
      <div className='px-10 flex flex-col items-center'>
        <h1 className='text-[36px] font-bold pb-20'>{data.title}</h1>
          ...
          {data.services.map((service) => (
            <div key={service.id} className='group relative'>
              ...
              <div className='border-zinc-200 rounded-lg bg-white  relative'>
                <div className='flex flex-row pt-10 px-[35px] h-[312px]'>
                  <Image className='h-[30px]' src={`${service.icon.url}`} width={30} height={30} alt='' />
