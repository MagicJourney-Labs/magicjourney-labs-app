          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-10 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
              ...
              <div className='grid justify-self-center self-center'>
                <Image src={`${homePage.imageUrl.url}`} alt={homePage.pictureAlt} className='w-[30rem] max-w-none rounded-xl ring-gray-400/10 sm:w-[30rem] md:-ml-4 lg:-ml-0' width={2200} height={1400} />
              </div>
            </div>
          </div>
        </div>
